...
namespace EFDbFirstApp.Models
{
    public partial class northwindContext : DbContext
    {
        ...
        public virtual DbSet<Kargolar> Kargolars { get; set; } = null!;
        public virtual DbSet<Kategoriler> Kategorilers { get; set; } = null!;
        public virtual DbSet<KategorilerView> KategorilerViews { get; set; } = null!;
        public virtual DbSet<OgrenciListesi> OgrenciListesis { get; set; } = null!;
        ...
        public virtual DbSet<SatisRaporlari> SatisRaporlaris { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            { 
                optionsBuilder.UseSqlServer("server=localhost,1433;uid=sa;database=northwind;pwd=Pro247!!;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KategorilerView>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KategorilerView");
            ...
            modelBuilder.Entity<OgrenciListesi>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("OgrenciListesi");

                entity.Property(e => e.Adi).HasMaxLength(10);

                entity.Property(e => e.Country).HasMaxLength(15);

                entity.Property(e => e.OgrenciId).ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<Urunler>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductName, "ClusteredIndex-20220908-095902")
                    .IsUnique()
                    .IsClustered();
